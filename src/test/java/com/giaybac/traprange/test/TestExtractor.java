...
//                    .setSource(sourceDirectory + File.separator + "sample-" + (idx + 1) + ".pdf");
            		  .setSource(sourceDirectory + File.separator + "dethi.pdf");
            switch (idx) {
                case 0: {
            ...
            try (Writer writer = new OutputStreamWriter(new FileOutputStream(resultDirectory + "//dethi-" + (idx + 1) + ".html"), "UTF-8")) {
